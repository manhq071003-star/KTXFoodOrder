    ...
    public static void initDatabase() {
        try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
            ...
            stmt.execute("INSERT OR IGNORE INTO foods VALUES " +
                    ...
                    "('F06', 'Bún đậu mắm tôm', 40000, 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=500', 1)," +
                    "('F07', 'Phở bò tái lăn', 40000, 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=500', 1)," +
                    "('F08', 'Trà đào cam sả', 20000, 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=500', 1)," +
